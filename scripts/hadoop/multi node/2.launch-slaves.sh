...
#do
	...
	instance_req_id=$(aws ec2 request-spot-instances --spot-price $1 --instance-count 16 --type "one-time" --launch-specification file://slave-specification.json --output text --query 'SpotInstanceRequests[*].SpotInstanceRequestId')
